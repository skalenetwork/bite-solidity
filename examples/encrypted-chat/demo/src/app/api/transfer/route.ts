// POST /api/transfer — transfer native CREDIT from one user to the other
import { NextRequest, NextResponse } from "next/server";
import { transferCredits } from "@/lib/service";
...
export async function POST(request: NextRequest) {
    try {
        ...
        const txHash = await transferCredits(userId as 1 | 2, amount);
